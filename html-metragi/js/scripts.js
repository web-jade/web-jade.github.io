...
$(document).ready(function(){
    $('.problems__slider-inner').owlCarousel({
        items: 1,
        loop: false,
        mouseDrag: false,
        animateOut: 'fadeOut',
    ...
    $('.problems__slider-item .close').click(function () {
        $(this).parent().removeClass('problems__slider-item_state_active');
    });

    $('.problems__slider-item .link').click(function (e) {
       e.preventDefault();
       $(this).parent().parent().addClass('problems__slider-item_state_active');
    });
});
$(document).ready(function(){
    $('.herro__slider').owlCarousel({
        ...
        mouseDrag: false,
        nav: true,
        navText: ['<img src="img/arrow-herro-left.png">', '<img src="img/arrow-herro-right.png">'],
        dots: true,
        smartSpeed: 700,
        dotsSpeed: 700,
        navSpeed: 700
...
$(document).ready(function () {
    ...
    $('.rate__arrow').click(function () {
        $(this).toggleClass('rate__arrow_state_active');
        $(this).parent().parent().find('div.rate__content').toggleClass('rate__content_state_active');
    });
});
$(document).ready(function(){
    $('.team__content-slider').owlCarousel({
        items: 1,
        margin: 80,
        loop: false,
        mouseDrag: false,
...
$(document).ready(function () {
    $('.header__hamburger').on('click', function () {
        $('.header__hamburger-menu').toggleClass('header__hamburger-menu_state_active');
        $('.header__menu').toggleClass('header__menu_state_active');
    });
});